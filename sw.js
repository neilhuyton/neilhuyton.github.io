...
self.__precacheManifest = [
  {
    "url": "webpack-runtime-0c7534b154301c9ef231.js"
  },
  {
    "url": "app-fdedbba79e14290b74bc.js"
  },
  {
  ...
  },
  {
    ...
    "revision": "9f4f8782e1b5b0e876c3df29076ad6c5"
  },
  {
    "url": "1.313656c7744a5158f815.css"
  },
  {
    "url": "0-c79a060125d85904f325.js"
  },
  {
    "url": "1-5aa1809e50477b3ebf57.js"
  },
  {
...
var navigationRoute = new workbox.routing.NavigationRoute(function (_ref) {
  ...
  return idbKeyval.get(WHITELIST_KEY).then(function (customWhitelist) {
    ...
    if (customWhitelist.includes(pathname)) {
      var offlineShell = "/neilhuyton.github.io/offline-plugin-app-shell-fallback/index.html";
...
var messageApi = {
  whitelistPathnames: function whitelistPathnames(event) {
    ...
    pathnames = pathnames.map(function (_ref3) {
      ...
      if (!includesPrefix) {
        return "/neilhuyton.github.io" + pathname;
      } else {
        return pathname;
      }
    });
